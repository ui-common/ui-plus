...
var resources = (function () {
  ...
  resources.label = function (ele) {
    ...
    if (l) {
      ...
      var key = ele.getAttribute("data-resource");
      if (key !== null && key.length > 0) {
        var r = resources.resource.resource();
        l = r.key;
  ...
  resources.labelFromContainer = function (ele) {
    var parent = resources.container(ele);
  ...
  resources.container = function (ele) {
