...
function phoneOnBlur(event) {
  checkOnBlur(event, "error_phone", validation_core_1.tel.isPhone, formatter_1.formatPhone);
}
exports.phoneOnBlur = phoneOnBlur;
function faxOnBlur(event) {
  checkOnBlur(event, "error_fax", validation_core_1.tel.isFax, formatter_1.formatFax);
}
